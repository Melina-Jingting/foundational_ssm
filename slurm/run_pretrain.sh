...
#SBATCH --output=slurm/logs/pretrain_%j.out
#SBATCH --error=slurm/logs/pretrain_%j.err
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --partition=gpu,gpu_lowp,a100
...
python scripts/training/pretrain_decoding.py model_cfg=configs/model/l2_sgd.yaml
