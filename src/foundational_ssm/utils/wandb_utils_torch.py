...
def generate_and_save_activations_wandb(
    model, data_tensor, run_name, project_name=None, run_id=None, save_dir="./outputs"
):
    """Generate predictions, capture activations, and save as H5 file."""
    os.makedirs(save_dir, exist_ok=True)
    h5_path = os.path.join(save_dir, "predictions_and_activations.h5")
    ...
    pred_artifact = wandb.Artifact(
        ...
        type="predictions",
        description="Model predictions and activations",
    )
