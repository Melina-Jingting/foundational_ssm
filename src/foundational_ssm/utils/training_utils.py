...
def log_validation_metrics(val_start_time, val_end_time):
...
def track_batch_timing(batch_count, minute_start_time, current_time):
...
def compute_r2_by_groups(preds, targets, held_out_flags, prefix="train"):
