...
def get_brainset_data_loader(
    ...
    window_length = sampler_args.get('window_length', window_length)  # Default to 1 if not provided
...
def get_brainset_train_val_loaders(
    ...
    train_dataset, train_loader, train_max_neural_units = get_brainset_data_loader( **train_loader_cfg, dataset_cfg=dataset_cfg, data_root=data_root)
    val_dataset, val_loader, val_max_neural_units = get_brainset_data_loader( **val_loader_cfg, dataset_cfg=dataset_cfg, data_root=data_root)
